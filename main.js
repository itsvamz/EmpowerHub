...
const Menu = () => {
    ...
    const getFullOptions = () => {
        return getOptions([{
                icon: "fa-solid fa-home", label: "Home", url: "index.html"
            }, {
                icon: "fa-solid fa-users", label: "Jobs", url: "link.html"
            }, {
                icon: "fa-solid fa-user", label: "Blogs", url: "poem.html"
            }, {
                icon: "fa-solid fa-chart-line", label: "Share", url: "form.html"
            }, {
